...
const userCols = `id, username, password_hash, must_change, created_at, disabled_at, last_login`
...
func scanUser(r scanner) (User, error) {
	...
	if err := r.Scan(&u.ID, &u.Username, &u.PasswordHash, &mc, &created, &dis, &last); err != nil {
