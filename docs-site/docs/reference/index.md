...
| The external decider webhook contract (request/response schemas, request signing) | [`backend/docs/decider-webhook.openapi.yaml`](https://github.com/alexandrosst/continuum-topology/blob/main/backend/docs/decider-webhook.openapi.yaml) (OpenAPI 3.1) |
